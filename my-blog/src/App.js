...
class App extends React.Component {
    ...
    render() {
      ...
      return (
        ...
        <div className='bg-gray-300  p-50' id="ArticleContainer">
          <h1 className="text-4xl underline mb-8">Simple blog with React</h1>
          <div className='AddArticle '>
           
            <input type='number' onChange={this.changeId} value={this.state.id} placeholder='Id of article'/>
            <form className="ring-red-600">
            <input className="" onChange={this.changeTitle} type='text' placeholder='Title' value={this.state.title} />
